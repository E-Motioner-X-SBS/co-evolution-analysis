...
The reason for the GPU is speed. The full MI matrix for 1,276 positions is 813,450 pairs. With the original pure Python Counter implementation this took more than 20 minutes and timed out. On the GPU the same computation takes about 1.6 seconds. That is roughly an 800x speedup.
...
4. The product P(372=A) * P(401=N) is about 0.40, but the observed joint P(A, N) = 0.6266. The ratio 0.6266 / 0.40 is about 1.57, so log2 of it contributes about 0.4 bits; the sum over all pairs gives MI = 1.5917 bits.
