...
\begin{abstract}
	...
	column pairs are contact-enriched by $3.2\times$.  All software, formal
	proofs, and result files are publicly available.
\end{abstract}

% ── Main text ──
\input{Nature_Sections/01-intro}
\input{Nature_Sections/02-related-work}
\input{Nature_Sections/03-theory-gray}
\input{Nature_Sections/04-theory-kmap-qm}
\input{Nature_Sections/05-theory-info-dca}
\input{Nature_Sections/06-theory-lean}
\input{Nature_Sections/07-results-transfer}
\input{Nature_Sections/08-results-gray-fusion}
\input{Nature_Sections/09-results-complete-circuit}
\input{Nature_Sections/10-results-reconstruction-negative}
\input{Nature_Sections/11-discussion}
% ── Methods ──
\input{Nature_Sections/12-methods-data}
\input{Nature_Sections/13-methods-encoding}
\input{Nature_Sections/14-methods-circuit}
\input{Nature_Sections/15-methods-eval}
% ── References ──
